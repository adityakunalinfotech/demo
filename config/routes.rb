Doctor::Application.routes.draw do
  ...
  resources    :enquiries
   ...
   root  :to => "home#index"
      ...
      namespace  :user do |user|
          resources    :vaidyas
          resources    :hospitals
      #    match 'user_session_path',      :to=>  'home#show'
           match 'user_registration_path', :to=> 'home#new',   :as => 'root'
      end
  ...
  #     resources :products
  #   endmatch users_sign_in_path => 'home#index'

  # You can have the root of your site routed with "root"
  # just remember to delete public/index.html.
  # root :to => 'welcome#Destroyindex'
